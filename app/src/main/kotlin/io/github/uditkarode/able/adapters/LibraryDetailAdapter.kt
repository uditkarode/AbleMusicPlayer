...
/**
 * Lists songs for the Library Detail (artist or album) screen. Taps invoke
 * [onItemClick] with the song's position in the list.
 */
class LibraryDetailAdapter(
    private val songList: ArrayList<Song>,
    private val onItemClick: (Int) -> Unit
) : RecyclerView.Adapter<LibraryDetailAdapter.RVVH>() {
