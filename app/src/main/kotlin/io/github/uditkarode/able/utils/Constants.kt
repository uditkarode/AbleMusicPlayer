...
class Constants {
    companion object {
        ...
        var playlistFolder = File(
            ableSongDir.absolutePath + "/playlists")

        /**
         * a File object pointing to the folder where all songs imported from Spotify
         * will be stored.
         */
        var playlistSongDir = File(ableSongDir.absolutePath + "/playlist_songs")

        /** a File object pointing to the folder where album art JPGs will be stored */
        var albumArtDir = File(ableSongDir.absolutePath + "/album_art")

        /** a File object pointing to the folder where temporary items will be stored */
        var cacheDir = File(ableSongDir.absolutePath + "/cache")
